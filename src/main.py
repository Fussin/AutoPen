...
from src.common.reporting import generate_reports
from src.common.config import load_config
from src.common.risk_scoring import calculate_risk_score
...
async def main():
    ...
    try:
        ...
        print("Warning: alive_domain.txt not found. Vulnerability scanning will be skipped.")
